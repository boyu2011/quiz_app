...
class ChoicesControllerTest < ActionController::TestCase
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post :create, choice: { content: @choice.content, correct: @choice.correct, question_id: @choice.question_id }
    end
  ...
  test "should update choice" do
    put :update, id: @choice, choice: { content: @choice.content, correct: @choice.correct, question_id: @choice.question_id }
    assert_redirected_to choice_path(assigns(:choice))
  end
